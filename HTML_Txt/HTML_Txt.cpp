                 ...
                 if (this.status == 200) { \n\
                  if (this.responseText != null){ \n\
					...
					if(data == \"zero\"){\n\
						...
						document.getElementById(\"outLabel\").innerHTML = this.responseText; \n\
					}\n\
                 }}}}\n\
...
const char* HTMLOutputBody(){
  return "<body onbeforeunload=\"return BeforeClose()\" onload=\"ReadReload()\"> \n\
		  ...
		  <br><div class=\"out-position\"><button type=\"button\" class=\"button buttonBasic\" id=\"outButton\" onclick=\"OutPressed()\">&#160;Out&#160; </button></div>\n\
