...
return "document.getElementById(\"startLabel\").innerHTML = \"Minimum amount of cable payed in!\";\n\
	document.getElementById(\"startLabel\").className = \"box Left Red\";\n\
	document.getElementById(\"outLabel\").innerHTML = \"\"; \n\
	document.getElementById(\"speedValue\").innerHTML = \"\"; \n\
	document.getElementById(\"speedSlider\").value = 0; \n\
...
<div class = \"control-panel\"><label for=\"maxLimit\">Set MAX Limit in M</label><input type=\"number\" class=\"number\" id=\"maxLimit\" min=\"0.5\" step=\"0.5\" oninput=\"SetMaxLimit()\">\n\
...
<input type=\"number\" class=\"number\" id=\"minLimit\" min=\"0.5\" step=\"0.5\" oninput=\"SetMinLimit()\"><label for=\"minLimit\">Set MIN Limit in M</label></div>\n\
